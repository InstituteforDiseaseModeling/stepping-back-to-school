...
# TODO: DONT NEEDS PARS - maybe just use as reps?  Although could still change answer, need to think about that!
par_inds = [0,1] if test_run else [0,10]
...
folder = 'v2020-12-02'
stem = f'testing_{par_inds[0]}-{par_inds[1]}'

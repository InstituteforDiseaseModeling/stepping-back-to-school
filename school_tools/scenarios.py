...
def screening_map():
    ...
    screen_map = sc.odict({ # tkey
        ...
        'Antigen every 1w teach&staff':             ('Weekly antigen for teachers & staff',             reds(1/6)),
        'Antigen every 4w':                         ('Monthly antigen',                                 reds(2/6)),
        'Antigen every 2w, no f/u':                 ('Fortnightly antigen, no f/u',                     reds(3/6)),
        'Antigen every 2w':                         ('Fortnightly antigen',                             reds(4/6)),
        'PCR every 2w':                             ('Fortnightly PCR, 1d delay',                       blues(3/6)),
        'Antigen every 1w':                         ('Weekly antigen',                                  reds(5/6)),
